        ...
        <div class="inner-container" :class="{ 'results-visible': resultsVisible && searchQuery }">
            ...
            <transition name="fade">
                <ul class="results" v-if="searchQuery && resultsVisible && apiResponse">
                    ...
                    <li class="no-results" v-if="searchQuery && (posts.length === 0) && (apiResponse)">Aucun résultat</li>
                </ul>
            </transition>
        </div>
...
<style lang="scss" scoped>
    ...
    .inner-container {
        ...
        button {
            ...
            &.clear {
                border-left: 1px solid lighten(#333436, 30%);
                padding: 0 12px;
                right: 0;
                top: 0;
                @media (max-width: 700px) {
        ...
        .input-container {
            ...
            input {
                border: 1px solid lighten(#333436, 30%);
                border-radius: 3px;
                font-family: 'Roboto', sans-serif;
                font-weight: 400;
                outline: 0;
                ...
                &::placeholder {
                    color: lighten(#333436, 30%);
                }
                &:focus {
                    border-color: lighten(#333436, 15%);
                    & + .clear {
                        border-color: lighten(#333436, 15%);
                    }
                    &::placeholder {
        ...
        .results {
            ...
            border: 1px solid lighten(#333436, 15%);
            ...
            li {
                line-height: 1.2;
                & + li {
                    border-top: 1px dotted lighten(#333436, 30%);
                }
                @media (min-width: 700px) {
                    &:nth-child(8) {
                ...
                a {
                    ...
                    transition: 0.1s;
                    &.active {
                        background-color: lighten(#333436, 70%);
                        color: darken(#333436, 30%);
                    }
                    .copy {
                        display: flex;
